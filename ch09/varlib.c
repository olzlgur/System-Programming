 ...
 * with facility tomark items as part of the environment
 *
 * interface:
...
#define MAXVARS 200	/* a linked list would the nicer */
...
/*
 * rturns value of var or empty string if not there
 */
{
	struct var *itemp;
 ...
 * rturns ptr to struct or NULL if not found
...
/*
 * build an array of pointers suitable for making anew environment
